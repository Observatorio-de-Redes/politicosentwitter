            ...
            div(class = "panel-heading", style = paste0("background-color:#ffffff"),
                div(class = "row",
                    div(class = "col-xs-10", style = "text-align: center;",
                        tags$a(tags$img(src=imagen_vb, height=width_,align = "center",width=height_,style="display: block; text-align:right;"),  href=web1)
                    ))
                ...
                div(class = "clearfix",
                    div(class = "row",
                        fluidRow(div(class = "col-xs-6",
                                     column(10),tags$a(icon(icon1, "fa-2x"),href=web1)
                        ),
                        div(class = "col-xs-4",
    ...
    div(class = "col-lg-3 col-md-10",
        div(class = "panel panel-primary",
            div(class = "panel-heading", style = paste0("background-color:#ffffff"),
                div(class = "row",
                    div(class = "col-xs-10",
                        tags$a( tags$img(src=imagen_vb, height=width_, width=height_,
                                        style="display: block; float:right; 
                                        right:50px;'"),  href=web1)
                    )
                ...
                div(class = "row",
                    ...
                    div(class = ("col-xs-9 text-right"),
                        div(style = "font-size: 25px; color: #15202b;font-weight: bold; text-align:center; ",
                            ...
                            column(5),h5(text2, style= "color: #7a7a7a; text-align:center"),
                        )
                ...
                div(class = "row",
                    fluidRow(    
                      ...
                      div(class = ("col-xs-9 text-right"),
                          div(style = "font-size: 25px; color: #15202b;font-weight: bold; text-align:center; ",
                              column(5),h4(text, style = "text-align:center; font-weight: bold;"), 
                              column(4),h5(text2, style= "color: #7a7a7a; text-align:center")
                          )
